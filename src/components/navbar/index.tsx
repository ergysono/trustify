...
export default function Navbar({ setShowWallet, showWallet }: Props) {
    ...
    return (
      <>
        ...
        />
        <div
          className="flex flex-row lg:flex-row h-[5rem] items-center justify-between px-4 lg:px-16 border-b-[1px] border-b-[#B2F1A8] relative"
        ...
        >
          ...
          <div
            className={`absolute z-20 top-[5rem] right-0 lg:static lg:flex flex-col lg:flex-row gap-4 ${
              menuOpen ? "flex" : "hidden"
            } lg:flex bg-[#1E1E1E] p-2`}
          >
            <button
              className="border shadow-[0_0_5px_#B2F1A8] rounded-md py-1 px-3"
            ...
            <button
              className="bg-[#B2F1A8] shadow-[0_0_5px_#B2F1A8] text-black rounded-md py-1 px-3 flex flex-row gap-2"
              onClick={
                authenticated
